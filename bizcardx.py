...
mydb = mysql.connector.connect(
    user='root',
    host='localhost',
    password='Hudson47*', auth_plugin='mysql_native_password')
...
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By HUDSON SYLVESTOR",
                   ...
                   menu_items={'About': """# This OCR app is created by *HUDSON SYLVESTOR A*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("C:/Users/31syl/Desktop/dataharvesting/business-card.png"), width=500)
